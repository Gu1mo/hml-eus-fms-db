create PROC [dbo].[usp_report_cycle_layer] @process_date DATE , @symbol VARCHAR(30) , @account INT 
as 
   SELECT a.account 
	    , a.symbol
		, b.order_id
		...
		, b.book_spread
		, b.order_spread
	 FROM tb_account_layer_hist a
LEFT JOIN tb_order_layer_cycle_hist b
